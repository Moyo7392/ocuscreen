  ...
  return (
    <div>
      <div className="relative flex min-h-[430px] items-center justify-center overflow-hidden rounded-xl bg-black/35">
        {/* eslint-disable-next-line @next/next/no-img-element */}<img src={visible ? heatmapUrl : imageUrl} alt={visible ? "Retinal image with model-attention heatmap overlay" : "Submitted retinal image without heatmap"} className="max-h-[650px] w-full object-contain" />
